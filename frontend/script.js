  ...
  chatBox.innerHTML += `
    <div class="message bot">
      <div class="bubble bot-bubble">
        <span><em>¿Necesitas ayuda? Han pasado 2 minutos sin actividad. Estoy aquí si tienes preguntas sobre tus clases.</em></span>
      </div>
    </div>
  `;
...
inactivityResetTimer = setTimeout(() => {
  chatBox.innerHTML += `
    <div class="message bot">
      <div class="bubble bot-bubble">
        <span><em>Tu sesión ha sido finalizada por inactividad. ¡Vuelve cuando necesites ayuda!</em></span>
      </div>
    </div>
  `;
  setTimeout(() => {
